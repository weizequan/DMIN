...
from model.supv_main_model import supv_main_model as main_model
...
def train_epoch(model, train_dataloader, criterion, criterion_event, criterion_self,optimizer, epoch):
    ...
    for n_iter, batch_data in enumerate(train_dataloader):
        ...
        is_event_scores, event_scores,event_self = model(visual_feature, audio_feature)
...
def validate_epoch(model, test_dataloader, criterion, criterion_event,criterion_self, epoch, eval_only=False):
    ...
    for n_iter, batch_data in enumerate(test_dataloader):
        ...
        is_event_scores, event_scores,event_class = model(visual_feature, audio_feature)
